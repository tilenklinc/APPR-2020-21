...
graf3
graf4 <- lineChart(AMZN, line.type = 'h', theme = 'white')


### GRAF 1
zdruzena2 <- zdruzena %>% filter(Tip == "Open")

#################

#graf5 <- candleChart(AMZN, TA=c(addMACD(),addVo()), subset = '2019', theme='white')
